...
//			System.out.println("Name");
			System.out.println("-------------------------------------------------------------------------------------------------");
			System.out.printf(" %10s %20s %22s %25s", "Candidate Name", "candidate Email", "Candidate Status ","Interviewer Name");
			System.out.println();
			System.out.println("-------------------------------------------------------------------------------------------------");
//	        System.out.println();
			for (Candidates cand : candListStatus) {
				System.out.format("%10s %25s %20s %25s", cand.getName(), cand.getEmail(), cand.getStatus(),cand.getinterviewerName());
				System.out.println();
