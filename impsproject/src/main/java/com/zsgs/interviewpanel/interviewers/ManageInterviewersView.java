...
//		System.out.println("Adding Interviewer..");
		try {
			...
			interviewer.setName(interviewerName.toLowerCase());
	...
	public void removeInterviewer() {
		...
		if (interviewModel.deleteInterviewer(name)) {
			...
			System.out.println("\nInterviewer Not Found Please Enter Correct Name.\n");
			initAdd();
		}
	}
...
//					System.out.println("\n"+Interv.getName() + "\t" + Interv.getAvailability() + "\t" + Interv.getInterviewerId()+"\n");
				System.out.format("%10s %25s %20s", Interv.getInterviewerId(), Interv.getName().toUpperCase(),
	...
	public  void showCandidatesList() {
		...
		for(Interviewers inter:interviewerList)
		{
			...
			{
				System.out.println("Interview Not yet Conducted!!!!!\nFirst Conduct Inteview..\n");
				break;
			}
		}
		}
